...
st.set_page_config(page_title="Covid19 Detection Tool", page_icon="Chapter08/Images/covid19.jpeg", layout='centered', initial_sidebar_state='auto')
...
def main():
	...
	st.sidebar.image("Chapter08/Images/covid19.jpeg",width=300)
		...
		if choice == 'Image Enhancement':
			...
			if st.sidebar.button("Diagnosis"):
				...
				if diagnosis == 0:
					...
					st.sidebar.error("DIAGNOSIS: Pneumonia")
